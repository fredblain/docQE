...
# get.sh
#
# Copyright (C) 2021 Frederic Blain (feedoo) <f.blain@sheffield.ac.uk>
#
...
extract(){
  ...
  add=''
  add2=''
  if [ ${year} == 15 ] || [ ${year} == 16 ] || [ ${year} == 17 ] || [ ${year} == 18 ] || [ ${year} == 19 ] || [ ${year} == 20 ]; 
  then
    add='-'${src}${tgt}
  fi
  if [ ${year} == 14 ];
  ...
  perl ../../../scripts/source-and-reference-from-sgm.perl ../newstest20${year}${add}-ref${add2}.${tgt}.${end} ../newstest20${year}${add}-src${add2}.${src}.${end} ${src} ${tgt}
...
# extract 08 english-german en de
# popd
#
# # 2009
...
# extract 09 english-german en de
# popd
#
# # 2010
...
# extract 10 english-german en de
# popd
#
# # 2011
...
# extract 11 english-german en de
# popd
#
# # 2012
...
# extract 12 english-german en de
# popd
#
# # 2013
...
# extract 13 english-german en de
# popd
#
# # 2014
...
# extract 14 english-german en de
# popd
#
# # 2015
...
# extract 15 english-german en de
# popd
#
# # 2016
...
# extract 16 english-german en de
# popd
#
# # 2017
...
# extract 17 english-german en de
# popd
#
# # 2018
# wget 'http://matrix.statmt.org/test_sets/newstest2018.tgz' -O newstest2018.tgz
# tar zxf newstest2018.tgz
# mv test newstest2018
# pushd newstest2018
# extract 18 german-english de en
# extract 18 english-german en de
# extract 18 english-russian en ru
# popd
#
# # 2019
# wget 'http://matrix.statmt.org/test_sets/newstest2019.tgz' -O newstest2019.tgz
# tar zxf newstest2019.tgz
# mv sgm newstest2019
# pushd newstest2019
# extract 19 german-english de en
# extract 19 english-german en de
# extract 19 english-russian en ru
# popd

# 2020
wget 'http://data.statmt.org/wmt20/translation-task/test.tgz' -O newstest2020.tgz
tar zxf newstest2020.tgz
mv sgm newstest2020
pushd newstest2020
extract 20 chinese-english zh en
popd
