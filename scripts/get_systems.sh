...
mkdir 2020 ; pushd 2020
echo "fetching 2020 data..."
# wget 'http://data.statmt.org/wmt20/translation-task/wmt20-submitted-systems.tgz' -O wmt20_all-newstranslation-task-systems.tgz

src='zh' ; tgt='en' ; lp='chinese-english'
mkdir ${lp} ; pushd ${lp} 
tar xf ../wmt20_all-newstranslation-task-systems.tgz --wildcards --no-anchored "wmt20-news-task-primary-submissions/sgm/system-outputs/${src}-${tgt}/"
mv wmt20-news-task-primary-submissions/sgm/system-outputs/${src}-${tgt}/* . ; rm -rf 'wmt20-news-task-primary-submissions'
extract 20 zh en
popd
